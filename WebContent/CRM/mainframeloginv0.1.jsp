...
<center>
		<div id="mainfunctions"
			style="width: 100%; position:fixed; top: 0px;border-bottom:1px solid #bbbbbb;height:50px">
		...
		<div id="mainfunctions"
			style="width: 88%; margin-left: 6%; margin-right: 6%;background-color:white;position:fixed; top:51px">
