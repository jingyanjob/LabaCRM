...
<div >
	...
	<div>
		<table cellpadding="0" cellspacing="0">
			<tr>
				<td width="120px">会员微博账号 </td>
				<td> <input id="userwbid" value="李开复"/></td>
				<td> <div id="vipusersearchstatus"></div> </td>
			</tr>
			
			<tr >
				<td style="border-bottom: 1px dashed gray"></td>
				<td style="border-bottom: 1px dashed gray"> <input id="vipusersearchbtn" value=" 查 询 " type="button" /></td>
				<td style="border-bottom: 1px dashed gray"> <div id="vipuserid"></div>
				</td>
			</tr>
			<tr>
				<td><br/>当前积分 </td>
				<td> <div  id="totalscoretxt"></div>
				<br/>
				</td>
				<td></td>
			</tr>
			...
			<tr>
				<td></td>
				<td> <input id="addvipuserscore" value=" 使 用 积 分(减) " type="button" />
				 <input id="reducevipuserscore"  value=" 增 加 积 分(加) " type="button" /></td>
