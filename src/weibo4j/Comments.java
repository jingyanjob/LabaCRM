...
public class Comments {
	 ...
	 * @since JDK 1.5
	 */
	public List<Comment> getMessges(Paging page,Integer filter_by_source,Integer filter_by_author) throws WeiboException{
		return Comment.constructComments(Weibo.client.get(WeiboConfig.getValue("baseURL")+"messages/receive.json",
				new PostParameter[]{
